...
img_path = "data/digit_images/digits_0.jpg"
...
cv2.imwrite("data/detected_and_classified_digits_thresh.png", thresh)
cv2.imwrite("data/detected_and_classified_digits.png", img)
