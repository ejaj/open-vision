...
def blend(foregroundSrc, backgroundSrc, dst, alphaMask):
    """
    Blend foreground and background images to a new image.
    :param foregroundSrc:
    :param backgroundSrc:
    :param dst:
    :param alphaMask:
    ...
    i = 0
    while i < numChannels:
        backgroundChannels[i][:] = normalizedAlphaMask * foregroundChannels[i] + normalizedInverseAlphaMask * \
...
def stroke_edges(src, dst, blurKsize=7, edgeKsize=5):
    """
    Stroked the edges of the image.
    :param src:
    :param dst:
    :param blurKsize:
    :param edgeKsize:
